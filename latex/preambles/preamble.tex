...
\pgfkeys{
	...
	category/.is choice,
	round/.is choice,
	category/jnr/.code={\edef\category{Junior}},
	category/snr/.code={\edef\category{Senior}},
	category/junior/.code=\pgfkeysalso{category/jnr},
	category/senior/.code=\pgfkeysalso{category/snr},
	round/mcq/.code={\edef\round{MCQ}},
	round/team/.code={\edef\round{Team}},
	round/obs/.code={\edef\round{Observation}}
	round/MCQ/.code=\pgfkeysalso{round/mcq},
	round/Team/.code=\pgfkeysalso{round/team},
}
...
\providecommand*{\acinstructions}[1]{
	\vspace*{20pt}
	\fbox{
		\fbox{
			\parbox{0.9\textwidth}{
